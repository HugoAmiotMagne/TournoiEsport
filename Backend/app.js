...
// Garantit la connexion DB avant chaque requête (important pour Vercel serverless)
app.use(async (req, res, next) => {
  try {
    ...
    res.status(503).json({ message: 'Service temporairement indisponible', error: err.message });
  }
});
